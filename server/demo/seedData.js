...
export const DEMO_CLUSTERS = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 96,
    description:
      "Large 3-foot diameter pothole exposing sub-base on MG Road near Trinity Circle. Active water pooling. Two minor accidents already reported this week.",
    lat: 12.9716,
    lng: 77.5946,
    reportCount: 3,
...
Community Hero — Civic Issue Tracking System`,
    complaintSubject:
      "URGENT: Critical Pothole at MG Road, Trinity Circle – Immediate Repair Required",
    workOrder: {
      title: "Emergency Pothole Repair – MG Road, Trinity Circle",
      priority: "P1 - Emergency",
      issueSummary:
        "3-foot diameter pothole on MG Road exposing sub-base material. Active water pooling. Two accidents reported.",
      steps: [
    ...
    citizenSummary:
      "Your report about a dangerous pothole on MG Road has been received and escalated to the Roads & Infrastructure Department with CRITICAL priority. Three citizens have reported this same hazard — which increases its urgency score. A repair crew is expected to be deployed within 24–48 hours. You may follow up using reference number BBMP-2026-RD-00431.",
    ...
    statusHistory: [
      { status: "Reported", at: daysAgo(5), note: "7-agent AI pipeline completed" },
      {
        ...
        at: daysAgo(5),
        note: "Formal complaint filed to Roads & Infrastructure Department",
      },
    ...
    geoContext: {
      available: true,
      road: "MG Road",
      suburb: "Trinity Circle",
      city: "Bengaluru",
      displayName: "MG Road, Trinity Circle, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 89,
      urgencyScore: 9.2,
      ...
      weatherInfluence:
        "Active monsoon rains are accelerating pothole expansion and increasing accident risk",
    ...
    contextResult: {
      ...
      historical: {
        count: 5,
        avgSeverity: "High",
        note: "5 pothole reports within 100m in past 6 months",
      },
    },
    createdAt: daysAgo(5),
    estimatedResolutionDays: 7,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 98,
    description:
      "Uncovered sewer manhole (60 cm diameter) on 100 Feet Road, Indiranagar. No cover, no barricade. Pedestrians and two-wheelers at immediate fall risk.",
    lat: 12.9784,
    lng: 77.6408,
    reportCount: 1,
    department: "Roads & Infrastructure Department",
...
Community Hero — Civic Issue Tracking System`,
    complaintSubject:
      "EMERGENCY: Uncovered Manhole on 100 Feet Road, Indiranagar – Immediate Hazard",
    workOrder: {
      title: "Emergency Manhole Cover Replacement – 100 Feet Rd, Indiranagar",
      priority: "P1 - Emergency",
      issueSummary:
        "Open 60cm manhole with no cover, barricade, or warning. Life-safety hazard on busy pedestrian stretch.",
      steps: [
    ...
    citizenSummary:
      "Your emergency report about an open manhole on 100 Feet Road has been flagged as a CRITICAL life-safety hazard and sent to the Roads Department with top priority. An emergency crew should be on site within 2 hours to install a temporary cover. Permanent repair is scheduled within 48 hours.",
    ...
    statusHistory: [
      { status: "Reported", at: daysAgo(2), note: "7-agent AI pipeline completed" },
      {
        status: "Complaint Drafted",
        at: daysAgo(2),
        note: "Emergency complaint filed to Roads & Infrastructure Department",
      },
    ],
    geoContext: {
      available: true,
      ...
      suburb: "Indiranagar",
      city: "Bengaluru",
      displayName: "100 Feet Road, Indiranagar, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 95,
      urgencyScore: 9.8,
      ...
      weatherInfluence:
        "Rain makes the exposed cavity invisible, dramatically increasing fall risk at night",
    ...
    contextResult: {
      ...
      historical: {
        ...
        note: "2 manhole incidents on this stretch in past year",
      },
    },
    createdAt: daysAgo(2),
    estimatedResolutionDays: 2,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 91,
    description:
      "4 consecutive streetlights non-functional on 80 Feet Road, Koramangala 4th Block. 200m stretch is completely dark after 8 PM. Multiple chain-snatching incidents reported in the area.",
    lat: 12.9352,
    lng: 77.6245,
    reportCount: 2,
...
Community Hero — Civic Issue Tracking System`,
    complaintSubject:
      "Urgent: 4 Non-Functional Streetlights on 80 Feet Road, Koramangala – Safety Risk",
    workOrder: {
      title: "Street Light Repair – 80 Feet Road, 4th Block Koramangala",
      priority: "P2 - Urgent",
      issueSummary:
        "4 consecutive lights non-functional for >5 days. 200m dark zone with security incidents.",
      steps: [
    ...
    citizenSummary:
      "Your report about non-functional streetlights on 80 Feet Road has been sent to BESCOM's Electrical Department. Two citizens have flagged this same stretch. A repair team is expected to restore lighting within 3 working days. The area police have also been notified about the safety concern.",
    ...
    statusHistory: [
      { status: "Reported", at: daysAgo(4), note: "7-agent AI pipeline completed" },
      {
        status: "Complaint Drafted",
        at: daysAgo(4),
        note: "Formal complaint filed to Electrical / Street Lighting Department",
      },
    ],
    geoContext: {
      available: true,
      road: "80 Feet Road",
      suburb: "Koramangala 4th Block",
      city: "Bengaluru",
      displayName: "80 Feet Road, Koramangala, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 67,
      urgencyScore: 7.1,
    ...
    contextResult: {
      ...
      historical: {
        count: 3,
        avgSeverity: "Medium",
        note: "3 streetlight complaints on this road in 12 months",
      },
    },
    createdAt: daysAgo(4),
    estimatedResolutionDays: 3,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 88,
    description:
      "Large illegal garbage dump (approx. 3 tonnes) at the end of 27th Main, HSR Layout Sector 2. Mixed waste including construction debris and food waste. Stray dogs breeding in the dump.",
    lat: 12.9116,
    lng: 77.637,
    reportCount: 2,
...
Community Hero — Civic Issue Tracking System`,
    ...
    workOrder: {
      ...
      priority: "P2 - Urgent",
      issueSummary:
        "~3 tonne mixed waste dump with construction debris. Stray animals breeding. Public health risk.",
      steps: [
    ...
    citizenSummary:
      "Your complaint about the illegal garbage dump on 27th Main has been received. Two residents have reported this location. The BBMP Solid Waste Management team has been alerted to clear the 3-tonne dump and sanitise the area within 5 working days. Bollards will be installed to prevent re-dumping.",
    ...
    statusHistory: [
      { status: "Reported", at: daysAgo(7), note: "7-agent AI pipeline completed" },
      {
        status: "Complaint Drafted",
        at: daysAgo(7),
        note: "Formal complaint filed to Solid Waste Management Department",
      },
    ],
    geoContext: {
      available: true,
      road: "27th Main",
      suburb: "HSR Layout Sector 2",
      city: "Bengaluru",
      displayName: "27th Main, HSR Layout, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 71,
      urgencyScore: 7.4,
      ...
      weatherInfluence:
        "Monsoon rains are washing leachate into storm drain — groundwater contamination risk",
    ...
    contextResult: {
      ...
      historical: {
        count: 4,
        avgSeverity: "High",
        note: "Repeat dumping location — 4 complaints in 6 months",
      },
    },
    createdAt: daysAgo(7),
    estimatedResolutionDays: 5,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 85,
    description:
      "Severe waterlogging on ITPL Main Road near Whitefield KPCT Mall. Water depth 2 feet. Road completely impassable for two-wheelers. Major tech park arterial route blocked.",
    lat: 12.9698,
    lng: 77.7499,
    reportCount: 1,
...
Community Hero — Civic Issue Tracking System`,
    complaintSubject:
      "Severe Waterlogging on ITPL Main Road, Whitefield – Emergency Dewatering Needed",
    workOrder: {
      title: "Emergency Dewatering & Drain Clearance – ITPL Main Road, Whitefield",
      priority: "P2 - Urgent",
      issueSummary:
        "2-foot waterlogging blocking primary tech-park arterial. Storm drain likely blocked by debris.",
      steps: [
    ...
    citizenSummary:
      "Your waterlogging report on ITPL Main Road has been sent to the Storm Water Drain Management Department. Emergency dewatering equipment should be deployed within 24 hours. As a major tech-park route, this has been escalated to the Ward Engineer for priority action.",
    ...
    statusHistory: [
      { status: "Reported", at: daysAgo(1), note: "7-agent AI pipeline completed" },
      {
        status: "Complaint Drafted",
        at: daysAgo(1),
        note: "Formal complaint filed to Storm Water Drain Management Department",
      },
    ],
    geoContext: {
      available: true,
      ...
      suburb: "Whitefield",
      city: "Bengaluru",
      displayName: "ITPL Main Road, Whitefield, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 62,
      urgencyScore: 6.8,
      ...
      weatherInfluence:
        "Ongoing monsoon rains will worsen flooding if drain not cleared within 24 hours",
    ...
    contextResult: {
      ...
      historical: {
        count: 6,
        avgSeverity: "High",
        note: "Recurring waterlogging at this underpass — 6 reports in 2 seasons",
      },
    },
    createdAt: daysAgo(1),
    estimatedResolutionDays: 1,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 82,
    description:
      "Broken and uneven footpath tiles on 11th Main, Jayanagar 4th Block. Several tiles missing, exposing soil. Dangerous for elderly and visually impaired pedestrians.",
    lat: 12.9308,
    lng: 77.5833,
    reportCount: 1,
    department: "Roads & Infrastructure Department",
...
Community Hero — Civic Issue Tracking System`,
    ...
    workOrder: {
      ...
      issueSummary:
        "Multiple broken/missing footpath tiles. Trip hazard, particularly for elderly.",
      steps: [
    ...
    citizenSummary:
      "Your footpath damage report on 11th Main, Jayanagar has been logged with the Roads Department. Scheduled repair is expected within 30 days under the BBMP Footpath Renewal Programme.",
    ...
    geoContext: {
      available: true,
      road: "11th Main",
      suburb: "Jayanagar 4th Block",
      city: "Bengaluru",
      displayName: "11th Main, Jayanagar 4th Block, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 45,
      urgencyScore: 4.8,
      ...
      proximityRisk:
        "Senior citizen walking park 80m away — elderly pedestrians frequently use this stretch",
      recommendedActions: [
    ...
    contextResult: {
      available: true,
      places: [{ name: "Jayanagar Senior Citizens' Park", type: "park", distanceM: 80 }],
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    confidence: 90,
    description:
      "Large rain tree (approximately 20m tall) dangerously leaning at 45° after last night's storm. Located on 5th Cross, Rajajinagar. Root ball partially exposed. Risk of full collapse onto vehicles and pedestrians.",
    lat: 12.9986,
    lng: 77.553,
    reportCount: 1,
...
Community Hero — Civic Issue Tracking System`,
    complaintSubject:
      "URGENT: Dangerously Leaning Tree on 5th Cross, Rajajinagar – Emergency Felling Required",
    workOrder: {
      title: "Emergency Tree Felling / Cable Bracing – 5th Cross, Rajajinagar",
      priority: "P2 - Urgent",
      issueSummary:
        "20m rain tree leaning 45° with exposed root ball after storm. Collapse risk within 24–48 hours.",
      steps: [
    ...
    citizenSummary:
      "Your tree hazard report on 5th Cross, Rajajinagar has been flagged as urgent. An arborist crew should assess the tree within 2 hours. The road will be temporarily closed for safety. Emergency felling or cable-bracing will be completed within 12 hours.",
    followUpDate: daysAgo(-1),
    statusHistory: [
      { status: "Reported", at: daysAgo(0), note: "7-agent AI pipeline completed" },
      {
        status: "Complaint Drafted",
        at: daysAgo(0),
        note: "Formal complaint filed to Parks & Horticulture Department",
      },
    ],
    geoContext: {
      available: true,
      road: "5th Cross",
      suburb: "Rajajinagar 1st Block",
      city: "Bengaluru",
      displayName: "5th Cross, Rajajinagar, Bengaluru",
    },
    riskAssessment: {
      priorityScore: 74,
      urgencyScore: 8.1,
      ...
      estimatedResolutionDays: 1,
      weatherInfluence:
        "Additional rain in the next 12 hours will further destabilise the root ball",
