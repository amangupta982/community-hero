  ...
  return (
    <div className="dash-view">
      <div className="dash-kpi-row">
        ...
        <StatCard label="Complaints Ready"  value={overview.complaintDrafted} icon="✉️" accent="#047857" />
      </div>

      <div className="dash-panel">
        <div className="dash-panel-head">
          <span className="dash-panel-title">Field Assignment Queue</span>
          <span className="dash-panel-sub">act on Critical first · urgency 10 = life-threatening</span>
        </div>
            ...
            {urgentActions.map((a, i) => {
              ...
              return (
                <div key={i} className={`officer-item ${urgCls}`}>
                  ...
                  {a.photo && (
                    <img src={a.photo} className="officer-thumb" alt="" loading="lazy" />
                  )}
