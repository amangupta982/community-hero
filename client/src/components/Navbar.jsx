  ...
  return (
    <nav className="navbar" role="banner">
      ...
      <div className="sidebar-nav">
        ...
        <button className="sidebar-nav-item" onClick={() => scrollInCol(".map-wrap")}>
          <span className="sidebar-nav-icon" aria-hidden>
            🗺️
          </span>
          <span className="sidebar-nav-label">Map View</span>
        </button>
        <button className="sidebar-nav-item" onClick={() => scrollInCol(".list")}>
          <span className="sidebar-nav-icon" aria-hidden>
            📋
          </span>
      ...
      <div
        ...
        role="button"
        tabIndex={0}
        onKeyDown={(e) => e.key === "Enter" && onDashboard()}
      >
        <div className="sidebar-ai-title">
          <span aria-hidden>🤖</span>
          AI Assistant
          <span className="sidebar-ai-arrow" aria-hidden>
            ›
          </span>
        </div>
      ...
      <div className="sidebar-community-card">
        <div className="sidebar-community-title">Together we can build better communities</div>
        <div className="sidebar-community-desc">
          Report issues. Track progress. See real change.
        </div>
        <span className="sidebar-community-emoji" aria-hidden>
          👷
        </span>
      </div>
